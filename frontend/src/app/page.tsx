...
export default function Home() {
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      {/* Stats Section */}
      <div className="w-full bg-slate-900/50 border-y border-slate-800">
        <PageContainer className="py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center divide-y md:divide-y-0 md:divide-x divide-slate-800">
            <div className="p-4">
              <p className="text-slate-400 text-sm uppercase tracking-widest font-bold mb-2">Total Orders</p>
              <p className="text-4xl font-extrabold text-white">{stats.totalOrders}</p>
            </div>
            <div className="p-4">
              <p className="text-slate-400 text-sm uppercase tracking-widest font-bold mb-2">Active Escrows</p>
              <p className="text-4xl font-extrabold text-indigo-400">{stats.activeEscrows}</p>
            </div>
            <div className="p-4">
              <p className="text-slate-400 text-sm uppercase tracking-widest font-bold mb-2">Completed Orders</p>
              <p className="text-4xl font-extrabold text-emerald-400">{stats.completedOrders}</p>
            </div>
          </div>
        </PageContainer>
      </div>
      ...
      <div className="bg-slate-900/30 border-t border-slate-800">
        <PageContainer className="py-24">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-extrabold text-white mb-4">Why Decentralized Escrow?</h2>
            <p className="text-slate-400 max-w-2xl mx-auto">
              Traditional platforms charge massive fees and hold your funds hostage. Web3 fixes this.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="flex flex-col">
              ...
              <h3 className="text-xl font-bold text-white mb-3">Locked & Immutable</h3>
            ...
            <div className="flex flex-col">
              ...
              <h3 className="text-xl font-bold text-white mb-3">Fair Dispute Resolution</h3>
              <p className="text-slate-400 leading-relaxed">
